...
public class DlgLine extends JDialog{
	...
	public DlgLine() {
		...
		lblStartPointX.setFont(new Font("Lucida Sans Typewriter", Font.BOLD, 14));
		...
		lblStartPointY.setFont(new Font("Lucida Sans Typewriter", Font.BOLD, 14));
		...
		lblEndPointX.setFont(new Font("Lucida Sans Typewriter", Font.BOLD, 14));
		...
		lblEndPointY.setFont(new Font("Lucida Sans Typewriter", Font.BOLD, 14));
		...
		btnColor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				color = JColorChooser.showDialog(btnColor, "Izaberite boju", Color.BLACK);
			}
		});
